...
<html>
  ...
  <head>
    <title> Contact | protein Shop</title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="peoteinlist.php"><span class="glyphicon glyphicon-cutlery"></span> Protein Zone </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Protein Shop </span>?</strong>
     <br>
