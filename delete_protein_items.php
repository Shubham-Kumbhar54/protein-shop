...
<html>
  ...
  <head>
    <title> Manager Login | protein </title>
  </head>

  <link rel="stylesheet" type = "text/css" href ="css/delete_protein_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_protein_items.php" class="list-group-item active">Delete protein Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_protein_items1.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> DELETE protein ITEMS FROM HERE </h3>
