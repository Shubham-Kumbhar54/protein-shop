...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/view_protein_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="view_protein_items.php" class="list-group-item active">View protein Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR PROREIN ITEMS LIST </h3>
