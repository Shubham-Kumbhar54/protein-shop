...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> protein Zone </a></li>
...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $F_ID = $values["protein_id"];
    $foodname = $values["protein_name"];
    $quantity = $values["protein_quantity"];
    $price =  $values["protein_price"];
    $total = ($values["protein_quantity"] * $values["protein_price"]);
    $R_ID = $values["S_ID"];
